...
from idavatar.unet_utils.ldm_modules_utils import (
    conv_nd,
    linear,
    avg_pool_nd,
    zero_module,
...
from idavatar.unet_utils.attention import SpatialTransformer
# from .positionnet  import PositionNet
from torch.utils import checkpoint
from idavatar.unet_utils.ldm_utils import instantiate_from_config
...
class UNetModel(nn.Module):
    def __init__(
        ...
        # This is param Beta in the instantbooth paper https://arxiv.org/abs/2304.03411
        # When in train, default 1; in inference, set to 0.3
        self.fuser_scale = fuser_scale
        ...
        self.middle_block = TimestepEmbedSequential(
            ...
            SpatialTransformer(
                ...
                key_dim=context_dim, 
                value_dim=context_dim, 
                n_heads=num_heads, d_head=dim_head, 
                depth=transformer_depth,
                fuser_scale=fuser_scale, 
                use_checkpoint=use_checkpoint
            ),
    ...
    # TODO: add controlnet
    def forward(self, noisy_latents, timesteps, encoder_hidden_states, person_embeds):
        # Grounding tokens: B*N*C == B*256*1024
        objs = person_embeds

        # Time embedding b*320
