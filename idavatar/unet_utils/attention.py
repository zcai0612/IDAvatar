...
class GatedSelfAttentionDense(nn.Module):
    def __init__(self, query_dim, context_dim,  n_heads, d_head, fuser_scale=1):
        super().__init__()
...
class BasicTransformerBlock(nn.Module):
    def __init__(self, query_dim, key_dim, value_dim, n_heads, d_head, fuser_scale, use_checkpoint=True):
        super().__init__()
        ...
        self.fuser = GatedSelfAttentionDense(query_dim, key_dim, n_heads, d_head, fuser_scale) 
...
class SpatialTransformer(nn.Module):
    def __init__(self, in_channels, key_dim, value_dim, n_heads, d_head, depth=1, fuser_scale=1, use_checkpoint=True):
        super().__init__()
        ...
        self.transformer_blocks = nn.ModuleList(
            [BasicTransformerBlock(query_dim, key_dim, value_dim, n_heads, d_head, fuser_scale, use_checkpoint=use_checkpoint)
